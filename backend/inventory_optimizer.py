...
def calculate_inventory_metrics(product_name):
    ...
    forecast, product_name = forecast_product(product_name)
...
"""
    ...
    return insight
#################### function only calculates for the top products#####################
# def calculate_inventory_metrics(product_name):

#     # Get forecast for top selling product
#     forecast, product_name = forecast_top_product(product_name)
